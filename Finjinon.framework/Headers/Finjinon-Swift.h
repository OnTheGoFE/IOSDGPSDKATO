...
SWIFT_CLASS("_TtC8Finjinon14CaptureManager")
...
@interface CaptureManager (SWIFT_EXTENSION(Finjinon)) <AVCapturePhotoCaptureDelegate>
...
@interface CaptureManager (SWIFT_EXTENSION(Finjinon)) <AVCaptureVideoDataOutputSampleBufferDelegate>
